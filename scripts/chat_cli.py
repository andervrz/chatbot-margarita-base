...
Uso:
    ...
    python scripts/chat_cli.py --session mi-sesion-123
"""
...
async def main() -> None:
    ...
    console.print(f"[{Colors.SYSTEM}]✓ Conectado a:[/{Colors.SYSTEM}] {args.db}")
    console.print(f"[{Colors.SYSTEM}]✓ LLM:[/{Colors.SYSTEM}] {settings.llm_model}")
